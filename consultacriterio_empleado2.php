...
// consulta a la tabla informe_personal	
	$consulta="SELECT * FROM empleado where match (cedula,nombre,horario) against ('$criterio*' IN BOOLEAN MODE)";
...
<p>&nbsp;</p>
<p>&nbsp;</p>
<p><strong>Consulta empleado</strong></p>
<p>&nbsp;</p>
<p>
  </CAPTION>
</p>
...
<?PHP
		...
		if ($fila ==0)
		{
		echo"El empleado $criterio no se encuentra registrado";
		}
		else 
		 //echo "$fila";
		while ($row = mysql_fetch_row($resultado))
    {
       $link2 =$row[11];
		...
		echo "<center><td><a align ='center' target=_blank href='$link2'><img src='$row[11]' align ='center'  width='120'height='100'></a></td></center></tr>";
		...
		echo "<td> Horas: $row[10]</td></tr>";
		echo "<td> Fecha: $row[7]</td>";
		echo "<td> Salario Mensual:$row[9]BsF.</td></tr>";
		
		$Diario1 = ($row[9]/30);
		$Diario= round($Diario1 * 100) / 100;
		echo"<tr><td>Salario por dia: $Diario BsF</td>";
		
		$xhora1=($Diario /$row[10]);
		$xhora=round($xhora1 * 100) / 100;
		echo "<td>Salario por hora:$xhora BsF</td></tr>";
		//$semana = ($fun * 5);
		//echo"<td> Sueldo Semanal $semana bsF</tdd></tr>";

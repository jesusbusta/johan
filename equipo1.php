<?php require_once('../Connections/piezas11.php'); ?>
<?php
mysql_select_db($database_piezas11, $piezas11);
$query_Recordset1 = "SELECT * FROM elementos_equipo";
$Recordset1 = mysql_query($query_Recordset1, $piezas11) or die(mysql_error());
...
do {  
?>
           <option value="<?php echo $row_Recordset1['nombre_elemento'],$row_Recordset1['nombre_elemento']?>"<?php if (!(strcmp($row_Recordset1['nombre_elemento'], $row_Recordset1['nombre_elemento']))) {echo "selected=\"selected\"";} ?>><?php echo $row_Recordset1['nombre_elemento']?></option>
           <?php
} while ($row_Recordset1 = mysql_fetch_assoc($Recordset1));
  $rows = mysql_num_rows($Recordset1);
  if($rows > 0) {
      mysql_data_seek($Recordset1, 0);
	  $row_Recordset1 = mysql_fetch_assoc($Recordset1); $row_Recordset1;
  }
?>
         </select>
       </tr>

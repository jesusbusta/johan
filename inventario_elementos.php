...
<?php
	...
	$consulta="SELECT * FROM elementos_equipo";
...
<p></strong></CAPTION>
  ...
  <TR>
	...
	<TH bgcolor="#E4E4E7" width="5">codigo-Partes</TH>
	<TH bgcolor="#E4E4E7" width="90">nombre-Partes</TH>
	<TH bgcolor="#E4E4E7" width="110">descripcion</TH>
	<TH bgcolor="#E4E4E7" width="130">Dimensiones</TH>
	<TH bgcolor="#E4E4E7" width="130">Equipo</TH>
   <TH bgcolor="#E4E4E7" width="120">Mostrar Foto</TH>
		...
		while ($row = mysql_fetch_row($resultado))
    {
		...
		//`id_elemento`, `cod_elemento`, `nombre_elemento`, `descripcion`, `dimensiones`, `archivo`, `titulo`, `equipo`
        echo "<center><td>$row[1]</td>";
		echo "<center><td>$row[2]</td>";
 ...
 <?PHP
		...
		$consulta="select count(nombre_elemento) from elementos_equipo";

...
<form action="mod_parte_elemento2.php" method="post" name="form1" id="form1">
<div align="center"><p>Modificar parte del elemento</p>
<br/><br/>
<table width="200" bgcolor="#BDBDBD" border="1" bordercolor="#FFFFFF">
<tr>
  <td width="80"><strong><div align="center">Codigo de la pieza</div></strong></td>

...
.Estilo3 {color: #000000; font-weight: bold; font-family: Arial; }
.Estilo4 {color: #000000; font-weight: bold; font-family: Arial; font-size: 12px; }
-->
    </style>
</head>
<body>
...
<p align="center" class="Estilo4"> Consultar por los siguientes parametros:</p>
...
<form action="consultacriterio_empleado2.php" method="post" name="form1" id="form1">
  <table width="250" border="5" align="center" bordercolor="#999999" bgcolor="#BDBDBD">
<tr>

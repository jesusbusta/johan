...
$codigo_herramienta=strtoupper($codigo_herramienta);
$nombre=strtoupper($nombre);
$Descripcion=strtoupper($Descripcion);


// funcion para insertar los ddatos en la tabla informe_personal
             $Insertar= "INSERT INTO herramientas 
VALUES('$codigo_herramienta','$nombre','$Descripcion','$cantidad','$costo','$ruta','$titulo')";

...
// consulta a la tabla informe_personal	
	...
	$consulta="SELECT * FROM elementos_equipo where match (cod_elemento,nombre_elemento,equipo) against ('$criterio*' IN BOOLEAN MODE)";
...
<?PHP
		...
		if ($fila ==0)
		{
		echo"La pieza $criterio no se encuentra registrado";
		}
		else 
		 //echo "$fila";

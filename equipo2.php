...
$estado=$_POST['estado'];
//foreach ($_POST['piezas'] as $value){echo ($value);}
$piezas=$_POST['piezas'];
...
$Insertar= "INSERT INTO equipo VALUES('$codigo_equipo','$nombre_equipo','$modelo','$marca','$descripcion','$fecha_ingreso','$cantidad','$estado','$piezas','$ruta','$titulo')";

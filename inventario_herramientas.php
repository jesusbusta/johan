...
<h2 class="art-postheader" align="center">Inventario</h2>
...
<p></strong></CAPTION>
  ...
  <TR>
	...
	<TH bgcolor="#E4E4E7" width="5">codigo-Herramienta</TH>
	<TH bgcolor="#E4E4E7" width="90">nombre-Herramienta</TH>
	<TH bgcolor="#E4E4E7" width="110">Descripcion</TH>
	<TH bgcolor="#E4E4E7" width="130">Cantidad</TH>
	<TH bgcolor="#E4E4E7" width="130">costo</TH>
...
//`codigo_herramienta`, `nombre`, `Descripcion`, `cantidad`, `costo`, `archivo`, `titulo`
		...
		echo "<td><a target=_blank href='$link2'><img src='$row[5]' width='120'height='100'></a></td>";
 ...
 <?PHP
		...
		$consulta="select count(nombre) from herramientas";
...

		{
			...
			echo "<a href=\"inventario_herramientas.php?pag=1\">|<<</a> <a href=\"pagina1.php?pag=".($pag-1)."\"></a> | ";

		}

		echo "<a href=\"inventario_herramientas.php\">Volver</a> | ";
...

		{
			...
			echo "<a href=\"inventario_herramientas.php?pag=".($pag+1)."\">>></a> <a href=\"pagina1.php?pag=".($paginas)."\">|</a>";

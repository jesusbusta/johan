...
<?php
 ...
 echo "<center><BR><p><strong><center>El empleado fu&eacute; eliminado</center></strong></p><BR></center><br>";
 mysql_close ($enlace);
 ?><!--fin de plantilla-->

<center><input name="image" type="image" src="images/Ok.png" align="bottom" />
</div>
<!--fin de plantilla-->

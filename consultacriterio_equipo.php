...
<form action="consultacriterio_equipo2.php" method="post" name="form1" id="form1" en enctype="multipart/form-data">
<br><br>
<p align="center" class="Estilo1"> Consulta</p>
<table width="200" border="3" align="center" cellpadding="2" cellspacing="1">
  <tr>
    <td width="97"><div align="center" class="Estilo1">Serial</div></td>
  </tr>
</table>

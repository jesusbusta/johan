...
if (!((strpos($tipo_archivo, "jpeg") || strpos($tipo_archivo, "gif")|| strpos($tipo_archivo, "png")|| strpos($tipo_archivo, "jpg")) && ($tamano_archivo < 100000000)))
{
...
// funcion para insertar los ddatos en la tabla informe_personal
             $Insertar= "INSERT INTO empleado VALUES('$cedula','$nombre','$apellido','$cargo','$telefono','$direccion','$sexo','$fecha','$horario','$salario','$horas','$ruta','$titulo')";
